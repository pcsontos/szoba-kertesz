...
- [ ] **Step 4: Futtatás — zöldnek kell lennie**
...
- [ ] **Step 3: A szerver-összeállítás megírása**
...
- [ ] **Step 1: A belépési pont megírása**
...
- [ ] **Step 3: Manuális füst-próba — indul-e egyáltalán**
...
- [ ] **Step 3: Élő próba — sikeres ág (2. sikerkritérium, első fele)**
...
- [ ] **Step 4: Élő próba — bukó ág (2. sikerkritérium, második fele)**
...
- [ ] **Step 1: A teljes CI-lánc lokálisan**
...
- [ ] **Step 2: A `git diff master -- packages/core` üres (9. sikerkritérium)**
...
- [ ] **Step 3: A `.mcp.json`/`.mcp.example.json` git-állapota (10. sikerkritérium)**
...
- [ ] **Step 4: Nincs commit ebben a Taskban**
