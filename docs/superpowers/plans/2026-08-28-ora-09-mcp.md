...
- [ ] **Step 1: A csomag `package.json`-ja**
...
- [ ] **Step 2: A három tsconfig, a `cli`/`server` mintájára**
...
- [ ] **Step 3: Vitest- és ESLint-konfig, a `cli`/`server` mintájára**
...
- [ ] **Step 4: A gyökér-projektek bekötése**
...
- [ ] **Step 6: A bukó teszt megírása (`plant-search-sql.spec.ts`)**
...
- [ ] **Step 7: Futtatás — el kell buknia (a modul még nem létezik)**

Run: `pnpm nx test mcp`
Expected: FAIL — `Cannot find module './plant-search-sql.js'` (vagy ezzel egyenértékű
feloldási hiba).

- [ ] **Step 8: A determinisztikus kereső megírása**
...
- [ ] **Step 9: Futtatás — zöldnek kell lennie**

Run: `pnpm nx test mcp`
Expected: PASS, mind a 11 teszt.

- [ ] **Step 10: Típus- és lint-ellenőrzés**
