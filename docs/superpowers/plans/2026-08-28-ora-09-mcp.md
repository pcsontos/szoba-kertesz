...
- [x] **Step 1: A live-check szkript megírása (nem kerül a repóba)**
...
- [x] **Step 3: A `logs/agent.log` bővült-e (6. sikerkritérium második fele)**
...
- [x] **Step 4: `/mcp` a Claude Code-ban (3. sikerkritérium) — EMBERI ellenőrzés**
...
- [x] **Step 5: A scratch szkript eltávolítása**
